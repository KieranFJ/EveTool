...
class Auth extends Controller {
	...
	function deactivate($id = NULL)
	{
        ...
        function new_account() {
            ...
            $this->form_validation->set_rules('api_key', 'API ID', 'required');
            $this->form_validation->set_rules('verification', 'Verification Code', 'required');
            ...
            if ($this->form_validation->run() == true)
            {
                    ...
                    $additional_data = array('api_key' => $this->input->post('api_key'),
            ...
            { //display the create user form
                    ...
                    $this->data['password_confirm'] = array('name' => 'password_confirm',
                     ...
                     $this->data['api_key'] = array('name' => 'api_key',
                            'id' => 'api_key',
                            'type' => 'text',
                            'value' => $this->form_validation->set_value('api_key'),
                    );
                      $this->data['verification'] = array('name' => 'verification',
                            'id' => 'verification',
                            'type' => 'text',
                            'value' => $this->form_validation->set_value('verification'),
                    );
                    
                    $this->load->view('auth/new_account', $this->data);
            }
        }

	//create a new user
        /* Leave uncommented unless needed
